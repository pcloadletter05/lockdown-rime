...
- [x] **FILE-01**: File Explorer has classic two-pane layout (tree view left, file list right)
- [x] **FILE-02**: Folder structure is loaded from content/files.json
- [x] **FILE-03**: Visitor can navigate by clicking folders in either pane
- [x] **FILE-04**: Files show type-appropriate icons (.doc, .xls, .txt, folder)
- [x] **FILE-05**: Double-clicking a file opens it in the appropriate viewer

### Document Viewers

- [x] **DOC-01**: WordPad-style viewer renders .doc content from JSON with basic formatting
- [x] **DOC-02**: Spreadsheet viewer renders .xls content in grid layout with column/row headers
- [x] **DOC-03**: Notepad viewer renders .txt content in minimal chrome with monospace text
- [x] **DOC-04**: All viewers have period-appropriate toolbars and menu bars (decorative)

### Email Client

- [x] **MAIL-01**: Outlook 98-style three-pane layout (folder tree, message list, preview)
- [x] **MAIL-02**: Folders include Inbox, Sent Items, Drafts, Deleted Items
- [x] **MAIL-03**: Message list shows sender, subject, date, read/unread styling
- [x] **MAIL-04**: Preview pane shows full email with headers (From, To, CC, Date, Subject)
- [x] **MAIL-05**: Reply chains render with > quoted text and corporate signatures
- [x] **MAIL-06**: Emails have deliver_at field; only emails whose deliver_at has passed are visible
- [x] **MAIL-07**: Email data loaded from content/emails.json

### Web Browser

- [x] **WEB-01**: IE5-style chrome with address bar, toolbar (Back/Forward/Stop/Refresh/Home)
- [x] **WEB-02**: Favorites sidebar with bookmarks from content/bookmarks.json
- [x] **WEB-03**: Default homepage is CalCom intranet page
- [x] **WEB-04**: At least 3 pre-built pages (CalCom intranet, corporate site, 1999 web portal)
- [x] **WEB-05**: Pages use late-90s web aesthetic (tables layout, visitor counters, beveled HRs)

### Survey Content

- [x] **SURV-01**: Survey folder contains CATI script, call disposition log, quota sheet, supervisor memo, training guide
- [x] **SURV-02**: Respondent profiles show official CATI records with Lisa's handwritten-style annotations
- [x] **SURV-03**: Cross-tabulation results contain subtly concerning data patterns
- [x] **SURV-04**: All survey documents render authentically in appropriate viewers
